...
Write-Host "  🛠️  ToolGit Build & Terminal Command Update  " -ForegroundColor White
Write-Host "═══════════════════════════════════════════════" -ForegroundColor Cyan
...
Write-Host "`n🎉 Success! You can now run 'toolgit' directly in any terminal." -ForegroundColor Green
